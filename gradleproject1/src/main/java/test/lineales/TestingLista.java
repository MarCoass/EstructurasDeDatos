...
public class TestingLista {
    ...
    public static void testMetodosAgregados() {
        //test de metodos agregados
        System.out.println("Creo lista [A B C D]");
        Lista original = new Lista();

        original.insertar('A', 1);
        original.insertar('B', 2);
        original.insertar('C', 3);
        original.insertar('D', 4);
        System.out.println("Lista original: " + original.toString());
        System.out.println("Prueba de metodo obtenerMultiplos(), busco los elementos en posiciones multiplos de 2:");
        Lista copia = original.obtenerMultiplos(2);
        System.out.println("Lista original: " + original.toString());
        System.out.println("Lista copia: " + copia.toString());
        System.out.println("Prueba de metodo obtenerMultiplos(), vacio la lista y busco los elementos en posiciones multiplos de 2:");
        original.vaciar();;
        copia = original.obtenerMultiplos(2);
        System.out.println("Lista original: " + original.toString());
        System.out.println("Lista copia: " + copia.toString());
    }
